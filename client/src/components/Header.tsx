            ...
            <div className="absolute right-0 mt-2 w-72 bg-white rounded-xl shadow-lg border border-gray-100 py-2 top-full overflow-hidden">
              ...
              <div className="py-1 border-t border-gray-100">
                <button 
                  ...
                  className={`w-full flex items-center gap-3 px-4 py-3 text-sm transition-colors text-left font-medium ${user?.isGuest ? 'text-brand-blue-600 hover:bg-brand-blue-50' : 'text-red-600 hover:bg-red-50'}`}
                >
                  {user?.isGuest ? (
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-brand-blue-500">
                  ...
                  {user?.isGuest ? 'Sign up / Sign in' : 'Logout'}
                </button>
              </div>
            </div>
          )}
